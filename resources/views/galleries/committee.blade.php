                        ...
                        <div class="col-xxl-4 col-sm-6">
                            <div class="blog-box wow fadeInUp">
                                <div class="blog-image">
                                    <a href="{{ url('/gallery/csr-gallery/details') }}" class="bg-size blur-up lazyload"
                                ...
                                <div class="blog-contain">
                                    ...
                                    <a href="{{ url('/gallery/csr-gallery/details') }}">
                                        <h3>one pot creamy mediterranean chicken pasta cream.</h3>
                                    </a>
                                    <button onclick="location.href = '{{ url('/gallery/csr-gallery/details') }}';" class="blog-button">Read
                                        More
                        ...
                        <div class="col-xxl-4 col-sm-6">
                            <div class="blog-box wow fadeInUp">
                                ...
                                <div class="blog-contain">
                                    ...
                                    <button onclick="location.href = '{{ url('/gallery/csr-gallery/details') }}';"
