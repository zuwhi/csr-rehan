...
@section('sub_title-2')
    ...
    <li class="breadcrumb-item">
        <a href="{{ url('/gallery/committee-gallery') }}">
            Kegiatan Komite
        </a>
    </li>
@endsection
                                ...
                                <li>
                                    <div class="user-box border-color">
                                        ...
                                        <div class="user-iamge">
                                            <img src="../../user/images/slider (1).jpg" class="img-fluid blur-up lazyload"
                                                alt="">
                                            <div class="user-name">
                                                <h6>30 Jan, 2022</h6>
                                    ...
                                    <div class="accordion-body pt-0">
                                        <div class="recent-post-box">
                                            ...
                                            <div class="recent-box">
                                                <a href="{{ url('/gallery/committee-gallery/details') }}" class="recent-image">
                                                    <img src="../../user/images/slider (1).jpg"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>

                                                <div class="recent-detail">
                                                    <a href="{{ url('/gallery/committee-gallery/details') }}">
