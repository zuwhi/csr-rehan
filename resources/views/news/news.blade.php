                        ...
                        <div class="col-xxl-4 col-sm-6">
                            <div class="blog-box wow fadeInUp">
                                <div class="blog-image">
                                    <a href="{{ url('/news/detail') }}" class="bg-size blur-up lazyload"
                                ...
                                <div class="blog-contain">
                                    ...
                                    <button onclick="location.href = '{{ url('/news/detail') }}';" class="blog-button">Read
                                        More
                        ...
                        <div class="col-xxl-4 col-sm-6">
                            <div class="blog-box wow fadeInUp">
                                ...
                                <div class="blog-contain">
                                    ...
                                    <button onclick="location.href = '{{ url('/news/detail') }}';"
                                    ...
                                    <div class="accordion-body pt-0">
                                        <div class="recent-post-box">
                                            ...
                                            <div class="recent-box">
                                                <a href="{{ url('/news/detail') }}" class="recent-image">
